 ...
 function initUI(response) {
    ...
    //set default layer slider value
     var h = dijit.byId("horizontalSlider");
     h.attr('value', 1);

     if (timeProperties && 0==1) {//don't use time slider at all
       ...
       //  dojo.connect(timeSlider, 'onTimeExtentChange',updateFromSlider);//sbtest updateTimeSliderTitle);
 ...
 function updateFromSlider(e) {
   ...
   var layer = map.getLayer(map.layerIds[e])
   layer.setVisibility(true);

   var s = layer._titleForLegend;
   dojo.byId("timeSliderLabel").innerHTML = s;
